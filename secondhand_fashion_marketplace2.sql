...
CREATE TABLE `products`  (
                             ...
                             `weight` int NOT NULL DEFAULT 500  COMMENT 'Khối lượng (gram), mặc định 500g',
                             `length` int NOT NULL DEFAULT 20   COMMENT 'Chiều dài (cm), mặc định 20cm',
                             `width`  int NOT NULL DEFAULT 15   COMMENT 'Chiều rộng (cm), mặc định 15cm',
                             `height` int NOT NULL DEFAULT 5    COMMENT 'Chiều cao (cm), mặc định 5cm',
                             `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                             `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                             PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `shops`  (
                          ...
                          -- GHN Address Fields
                          `province_id`    int          NULL DEFAULT NULL COMMENT 'GHN Province ID',
                          `province_name`  varchar(100) NULL DEFAULT NULL COMMENT 'Tên tỉnh/thành',
                          `district_id`    int          NULL DEFAULT NULL COMMENT 'GHN District ID',
                          `district_name`  varchar(100) NULL DEFAULT NULL COMMENT 'Tên quận/huyện',
                          `ward_code`      varchar(20)  NULL DEFAULT NULL COMMENT 'GHN Ward Code',
                          `ward_name`      varchar(100) NULL DEFAULT NULL COMMENT 'Tên phường/xã',
                          `address_detail` text         NULL DEFAULT NULL COMMENT 'Địa chỉ chi tiết',
                          `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                          `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                          PRIMARY KEY (`id`) USING BTREE,
